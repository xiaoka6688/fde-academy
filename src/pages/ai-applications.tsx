...
const CATEGORIES: CategoryGroup[] = [
  {
    ...
    products: [
      ...
      {
        name: 'Claude Code',
        tagline: '终端里的编程 Agent，开发者工作流新标配',
        description: 'Anthropic 官方 CLI Agent：理解整个代码库、跨文件改动、执行测试与 Git 操作，支持技能系统与 MCP 扩展。2026 年与 Codex 一起成为开发者迁移的主要方向（36氪：大量开发者用户流向 Codex 与 Claude Code）。本站有[完整使用指南](/tools/claude-code-guide)。',
        category: '编程工具',
        url: 'https://claude.com/claude-code',
        pricing: 'Pro/Max 订阅 / API 计费',
        highlight: '终端 Agent 标配',
        launchDate: '2026 主流化',
      },
      {
        name: 'OpenAI Codex',
        tagline: '云端 + CLI 双形态编程 Agent',
        description: 'OpenAI 的软件工程 Agent：云端沙箱并行处理多个任务（PR、修 Bug、写测试），CLI 本地形态与 Claude Code 直接竞争。2026 年在编码基准与真实工程任务上与 Claude 掰手腕，是开发者 Agent 化的另一主入口。',
        category: '编程工具',
        url: 'https://openai.com/codex',
        pricing: 'ChatGPT 订阅 / API 计费',
        highlight: '云端并行任务',
        launchDate: '2026 主流化',
      },
    ],
  },
  {
    ...
    products: [
      ...
      {
        name: 'Manus',
        tagline: '通用自主 Agent 标杆，"AI Agent 的 ChatGPT 时刻"',
        description: '给一个高级目标即可自主拆解执行：沙箱化虚拟机运行、Skill 技能复用、异步云端交付。与 Genspark 并称通用 Agent 双雄，2026 年 Web/移动端付费用户快速增长、收入半年翻倍（36氪）。清华大学报告指出通用智能体竞争已从模型层转向产品层，Manus 是核心玩家。',
        category: 'Agent 平台',
        url: 'https://manus.im',
        pricing: '免费额度 + 订阅制',
        highlight: '通用 Agent 双雄',
        launchDate: '2026 持续爆火',
      },
      {
        name: 'Genspark',
        tagline: 'Super Agent：多智能体协作工作台',
        description: 'Manus 的最强竞对：AI Slides 幻灯片生成、Deep Research、事实核查、图片/视频生成一体化，多智能体分工具协作交付。融资累计 26 亿美元，被多个评测视为"Manus 全面升级版"。',
        category: 'Agent 平台',
        url: 'https://www.genspark.ai',
        pricing: '免费额度 + 订阅制',
        highlight: '多智能体工作台',
        launchDate: '2026 快速增长',
      },
      {
        name: 'Devin (Cognition)',
        tagline: 'AI 软件工程师：异步完成真实开发任务',
        description: '最清晰的"AI 工程师"押注：自带终端、编辑器、浏览器，可独立接 Jira/Linear 任务、写 PR 并自测。2026 年实践共识是需要工作流层面的治理（代码评审、任务边界）才能稳定产出。',
        category: 'Agent 平台',
        url: 'https://devin.ai',
        pricing: '按 ACU 计费',
        highlight: 'AI 软件工程师',
      ...
      {
        name: 'ChatGPT Agent (OpenAI)',
        tagline: '巨头生态的任务交付型 Agent',
        description: 'OpenAI 把浏览器操作、终端执行、API 调用整合进 ChatGPT：一句话让它订机票、做调研报告、生成 PPT。依托最大用户盘子成为普通用户接触 Agent 的第一入口。',
        category: 'Agent 平台',
        url: 'https://openai.com',
        pricing: 'Plus/Pro 订阅',
        highlight: '巨头 Agent 入口',
        launchDate: '2026 普及',
      },
    ],
  },
  ...
  },
  {
    ...
    products: [
      ...
      {
        name: '豆包工作（字节跳动）',
        tagline: '字节办公 Agent 品牌：整合 TRAE、扣子与飞书',
        description: '2026 年 8 月 25 日正式发布的生产力 Agent 产品：围绕用户目标自主拆解任务、调用工具、持续推进复杂工作，与飞书深度打通。标志 Agent 时代第一场巨头级办公战役打响（新浪财经），与腾讯 WorkBuddy 同月对垒。',
        category: '国内应用',
        url: 'https://www.donews.com/news/detail/4/6685020.html',
        highlight: '字节全系整合',
        launchDate: '2026-08 发布',
      },
      {
        name: 'TRAE',
        tagline: '字节 AI IDE + TraeWork 办公平台',
        description: 'AI 原生 IDE：覆盖字节内部 80% 工程师，2026 年编程工具横评代码能力 8.0 分、国内可用性 9.5 分（免翻墙"免费党"优选）。TraeWork 提供 Work/Code/Design 一键切换，可调用飞书、微信、钉钉插件自动生成 PPT、数据分析与深度研究。',
        category: '国内应用',
        url: 'https://www.trae.ai',
        pricing: '免费 / Pro 订阅',
        highlight: '国内 AI IDE 一哥',
        launchDate: '2026 主流化',
      },
      {
        name: 'WorkBuddy（腾讯）',
        tagline: 'AI Agent 办公新范式：桌面智能体工作台',
        description: '腾讯云 CodeBuddy 团队推出的 AI 办公 Agent：自主规划并交付多模态复杂任务，多 Agent 并行、跨应用与文件操作、可持续跟进项目数小时。个人版 3 个月迭代 43 个版本（约 2 天一版），另设企业版覆盖 Agent 全生命周期治理。',
        category: '国内应用',
        url: 'https://www.codebuddy.cn/work/',
        pricing: '免费 / 企业版定制',
        highlight: '腾讯办公 Agent',
        launchDate: '2026 快速迭代',
      },
      {
        name: '豆包（字节跳动）',
        tagline: '字节 C 端超级入口：AI 产品向豆包集结',
        description: '2026 年 8 月连续上线手机远程控制电脑、Windows 虚拟桌面（本地/云双模式）、侧边工作台、技能商店（200+ 技能）与连接器——豆包成为字节全系 AI 能力的统一 Agent 入口。另试水"上下文定价"新模式。',
        category: '国内应用',
        url: 'https://www.doubao.com',
        pricing: '免费',
        highlight: '200+ 技能商店',
        launchDate: '2026-08 集结',
      },
    ],
  },
];
...
const KEY_TRENDS = [
  ...
  '办公 Agent 成为新战场：字节"豆包工作"（整合 TRAE/扣子/飞书）与腾讯 WorkBuddy 同月对垒，通用 Agent 双雄 Manus/Genspark 付费增长翻倍',
  '国内 AI 应用生态加速追赶——豆包、Kimi、通义、微信 Agent 各有杀手级场景',
